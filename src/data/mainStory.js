export const MAIN_STORY = {
  ...
  missions: {
    ...
    prologue_debt: {
      ...
      category: 'main',
      npc: 'vexer',
      description: 'Барон Вексер дал тебе корабль и 2500 кредитов. Взамен ты должен 30000. У тебя 60 дней. Торгуй, бери заказы, делай что угодно - но верни деньги. Или потеряешь всё.',
      hint: 'Торгуй между системами, бери квесты в барах, участвуй в событиях. Каждый день на счету.',
      completionText: 'Ты скопил достаточно. Пора связаться с Вексером.',
      objectives: [
        { type: 'credits', amount: 15000, text: 'Накопить 15000 кредитов (первый взнос)' },
        { type: 'day', min: 5, text: 'Дожить до 5 дня' },
        { type: 'visit', system: 'centauri', text: 'Посетить Центавру (офис Вексера)' },
      ],
